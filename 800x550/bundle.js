  ...
  var Banner = {
    init: function init() {
      ...
      function addRollover() {
        // Creas la tl acá para que sea accesible desde ambos event listeners
        var tl = new gsap.timeline();
        dom.ad_content.addEventListener('mouseenter', function () {
          // Haces lo que tengas que hacer con el tl
          tl.to('#pegasus_3', 1, {
            y: '5',
            ease: 'sine.inOut',
            repeat: 5,
            yoyo: true
          }); // Si la tl está pausada entonces resumila desde dónde quedó
